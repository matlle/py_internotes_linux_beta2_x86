...
class Printing(QDialog):
    def __init__(self, in_student_tree, parent):
        super(Printing, self).__init__(parent)
    ...
    def setHeader(self):
        header_image = u""
        if Printing.isAccountHasLogo() == False: 
    ...
    def printDialog(self):
        ...
        dialog.setWindowTitle(u"Imprimer - InterNotes")
        ...
        if dialog.exec_():
            ...
            while s < len(stds_id):
                ...
                if include_header == True:
                    ...
                    rect_header_company_name = QRect(x, y, w_header_company_name, fm_height + 5) 
                ...
                if std_photo_name.isEmpty() or \
                    ...
                    self.painter.drawRect(rect_photo)
                    if Printing.isAccountHasLogo() == True: 
                        self.painter.drawText(
    ...
    def printPreviewDialog(self):
        ...
        page_setup = QPageSetupDialog(printer, self)
        page_setup.exec_()

        preview_dialog = QPrintPreviewDialog(printer, self)


        self.connect(preview_dialog, SIGNAL("paintRequested(QPrinter*)"), self.printerPreview)

        preview_dialog.setWindowTitle(u"Imprimer - InterNotes")
    ...
    def init(self):
        ...
        self.btn_print = QPushButton(u"Imprimer")
        self.btn_print.setEnabled(False)
        self.btn_print_preview = QPushButton(u"Aperçu avant impression")
        self.btn_print_preview.setEnabled(False)
        self.btn_exit = QPushButton(u"Quitter")
        self.btn_exit.setIcon(QIcon(":/images/editdelete.png"))
        self.btn_print.setIcon(QIcon(":/images/printer.png"))
        self.btn_print_preview.setIcon(QIcon(":/images/printpreview.png"))
        ...
        btn_box.addButton(self.btn_print, QDialogButtonBox.YesRole)
        btn_box.addButton(self.btn_print_preview, QDialogButtonBox.YesRole)
        ...
        self.setWindowTitle(u"Imprimer - InterNotes")
        ...
        self.connect(self.btn_print, SIGNAL("clicked()"), self.printDialog)
        self.connect(self.btn_print_preview, SIGNAL("clicked()"), self.printPreviewDialog)
