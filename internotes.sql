...
CREATE TABLE `away` (
  ...
  `away_date` varchar(50) DEFAULT NULL,
  `away_time_from` time DEFAULT NULL,
  `away_time_to` time DEFAULT NULL,
  `away_justify` enum('Non Justifiée','Justifiée') DEFAULT 'Justifiée',
  `away_motif` text,
  `away_created_at` datetime DEFAULT NULL,
  `away_updated_at` datetime DEFAULT NULL,
  `away_period` varchar(50) DEFAULT NULL,
...
-- Dump completed on 2015-08-24 19:25:36
